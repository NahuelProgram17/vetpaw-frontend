        ...
        <>
            ...
            <div style={{ minHeight: '100vh', background: DARK, fontFamily: FONT }}>
                ...
                <div className="section-pad" style={{ padding: '28px 40px' }}>
                    <div className="banner-ad-wrap" style={{ borderRadius: 24, overflow: 'hidden', position: 'relative', background: `linear-gradient(120deg, #0f1923 0%, #1a1060 50%, #3d1a00 100%)`, boxShadow: `0 8px 48px rgba(255,152,0,0.2)`, minHeight: 200, display: 'flex', border: '1px solid rgba(255,152,0,0.15)' }}>
                        <div className="banner-ad-foto" style={{ width: 260, flexShrink: 0, position: 'relative', overflow: 'hidden' }}>
                            <img src="https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=500&q=85" alt="Perro" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center top', display: 'block' }} />
                        ...
                        <div className="banner-ad-info" style={{ flex: 1, padding: '32px 28px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            ...
                            <button style={{ background: `linear-gradient(135deg, ${G1}, ${O1})`, color: '#fff', fontWeight: 800, fontSize: 13, padding: '12px 24px', borderRadius: 12, border: 'none', cursor: 'pointer', alignSelf: 'flex-start', boxShadow: `0 4px 20px rgba(76,175,80,0.35)`, fontFamily: FONT, animation: 'btnBounce 0.6s 0.4s cubic-bezier(.22,.68,0,1.4) both' }}>Comprar ahora</button>
                        </div>
                        <div className="banner-ad-centro" style={{ width: 220, flexShrink: 0, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '24px 20px', gap: 12, borderLeft: '1px solid rgba(255,255,255,0.07)', borderRight: '1px solid rgba(255,255,255,0.07)' }}>
                            {[{ icon: '✅', text: 'Elimina pulgas y garrapatas' }, { icon: '🐶', text: 'Para perros y gatos' }, { icon: '⏱️', text: 'Efecto hasta 3 meses' }, { icon: '🚫', text: 'Sin receta médica' }, { icon: '🚚', text: 'Envío gratis a todo el país' }].map((b, i) => (
                        ...
                        <div className="banner-ad-precio" style={{ width: 200, flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px 16px', gap: 6, background: 'rgba(255,255,255,0.03)', overflow: 'visible' }}>
                            <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', textDecoration: 'line-through' }}>$14.000</span>
                            <div className="banner-precio-num" style={{ fontSize: 40, fontWeight: 900, color: O1, lineHeight: 1, fontFamily: FONT, whiteSpace: 'nowrap', animation: 'pricePop 0.6s 0.2s cubic-bezier(.22,.68,0,1.4) both, pricePulse 2s 1s ease-in-out infinite' }}>$10.000</div>
                            <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.45)', textAlign: 'center' }}>precio especial</span>
                            <div className="banner-oferta-badge" style={{ marginTop: 8, background: O1, color: '#fff', fontSize: 12, fontWeight: 900, padding: '6px 16px', borderRadius: 99, whiteSpace: 'nowrap', flexShrink: 0 }}>🔥 OFERTA</div>
                        </div>
                    </div>
