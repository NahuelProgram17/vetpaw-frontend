...
import { getAppointments, confirmAppointment, cancelAppointment, createVisit, getPets } from "../services/api";
...
return (
        ...
        <div className="appts-list">
            ...
            return (
                ...
                <div className="appt-actions">
                    {appt.status === "pending" && (
                    <>
                        <button className="btn-confirm" onClick={() => handleConfirm(appt.id)}>
                        ✅ Confirmar
                        </button>
                        <button className="btn-cancel-sm" onClick={() => handleCancel(appt.id)}>
                        ✕ Cancelar
                        </button>
                    </>
                    )}
                    ...
                    <>
                        <button className="btn-visit" onClick={() => openVisitModal(appt)}>
                        📋 Cargar visita
                        </button>
                        <button className="btn-cancel-sm" onClick={() => handleCancel(appt.id)}>
                        ✕ Cancelar
                    ...
                    <span className="done-label">✅ Visita registrada</span>
                    )}
                    {appt.status === "cancelled" && (
                    <span className="cancelled-label">✕ Cancelado</span>
                    )}
                </div>
                </div>
            );
    ...
    {showVisitModal && (
        ...
        <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="form-section">
                ...
                <textarea name="diagnosis" rows={2} placeholder="Diagnóstico de la consulta..." value={visitForm.diagnosis} onChange={handleVisitChange} />
                </div>
                <div className="form-group">
    ...
    <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .success-toast {
        background: rgba(107,255,184,0.12); border: 1px solid rgba(107,255,184,0.3);
        color: #6bffb8; padding: 10px 16px; border-radius: 10px; font-size: 0.88rem; font-weight: 700;
        ...
        background: rgba(107,255,184,0.10); border-radius: 10px;
        ...
        .btn-confirm {
        background: rgba(107,255,184,0.12); border: 1px solid rgba(107,255,184,0.3);
        color: #6bffb8; border-radius: 8px; padding: 7px 14px;
        ...
        color: rgba(255,107,107,0.7); border-radius: 8px; padding: 6px 14px;
        ...
        border-radius: 24px; padding: 32px; width: 100%; max-width: 560px;
        ...
        .section-title {
        font-size: 0.85rem; font-weight: 900; color: rgba(255,255,255,0.6);
        ...
        border-color: #6bffb8; box-shadow: 0 0 0 3px rgba(107,255,184,0.10);
        }
        ...
        .btn-primary {
        background: linear-gradient(135deg, #6bffb8, #3de09a);
        color: #1a1a2e; border: none; border-radius: 10px; padding: 11px 22px;
