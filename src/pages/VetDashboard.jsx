    ...
    return (
      <section className="vp-pet-detail">
        ...
        <section className="vp-card vp-clinical-photos" id="vp-clinical-files">
          <h3 className="vp-section-title"><span className="vp-section-icon">📎</span> Archivos clínicos</h3>
          ...
          {clinicalPhotos.length === 0 ? (
            <EmptyState icon="📎" title="Sin archivos clínicos" text="Subí fotos, estudios o documentos PDF asociados a este paciente." compact />
          ) : (
...
function PetMainCard({ pet, visits, vaccines, onFile, onPdf, onUploadFile, onVaccine, detailed = false }) {
    ...
    <article className={`vp-pet-card ${detailed ? "detailed" : ""}`}>
      ...
      <div className="vp-pet-info">
        ...
        <div className="vp-pet-actions">
          ...
          <button className="gradient" onClick={onUploadFile}>📎 Subir archivo</button>
