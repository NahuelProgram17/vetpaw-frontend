...
export default function ClinicDashboard() {
  ...
  const openClinicalFile = async (file) => {
    ...
    try {
      ...
      const type = response.headers?.["content-type"] || file.content_type || (isClinicalPdf(file) ? "application/pdf" : "application/octet-stream");
      ...
      if (fallbackUrl) {
        ...
        showMessage("error", "No se pudo abrir el archivo clínico.");
      }
    }
  };
    ...
    return (
      <section className="vp-pet-detail">
        ...
        <PetMainCard
          ...
          onVisit={() => openControlModal(selectedPet)}
        ...
        <section className="vp-card vp-clinical-photos">
          <h3 className="vp-section-title">📎 Archivos clínicos</h3>
    ...
    <article className={`vp-pet-card ${detailed ? "detailed" : ""}`}>
      ...
      <div className="vp-pet-info">
        ...
        <div className="vp-pet-actions">
          ...
          <button className="gradient" onClick={onVisit}>📅 Programar control</button>
