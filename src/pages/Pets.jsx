...
export default function Pets() {
    ...
    return (
                        ...
                        {pets.map((pet) => (
                            <div key={pet.id} className="pet-card">
                                <div className="pet-card-top">
                                    <div className="pet-avatar-lg">{petEmoji(pet.species)}</div>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        border-radius: 8px; padding: 6px 8px; cursor: pointer; font-size: 1rem;
        ...
        color: #ff6b6b; border-radius: 10px; padding: 9px;
        ...
        .btn-danger {
        background: linear-gradient(135deg, #ff6b6b, #ff4a4a);
        border: none; color: #fff; border-radius: 10px; padding: 8px 16px;
        font-family: 'Nunito', sans-serif; font-weight: 700; cursor: pointer;
        }
