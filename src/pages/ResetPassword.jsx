...
export default function ResetPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await confirmPasswordReset(uidb64, token, form.password, form.password2);
            setSuccess(true);
            setTimeout(() => navigate("/login"), 3000);
        } catch (err) {
            setError(err.response?.data?.error || err.userMessage || "El link expiró o ya fue usado.");
        ...
        <div className="auth-page">
            ...
            <div className="auth-card">
                ...
                {!success ? (
                    <>
                        ...
                        <form onSubmit={handleSubmit} className="auth-form">
                            ...
                            <button type="submit" className="auth-btn" disabled={loading}>
                                {loading ? <span className="btn-loading"><span className="spinner" /> Guardando...</span> : "Guardar contraseña ✅"}
                            </button>
                        </form>
                    </>
                ) : (
                    <div style={{ textAlign: 'center', padding: '20px 0' }}>
                        ...
                        <p style={{ color: '#6bffb8', fontWeight: 700, fontSize: '1rem', marginBottom: 8 }}>¡Contraseña actualizada!</p>
            ...
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .blob-1 { width: 420px; height: 420px; background: #ff6b6b; top: -100px; left: -120px; }
                .blob-2 { width: 320px; height: 320px; background: #ffd93d; bottom: -80px; right: -80px; }
                .blob-3 { width: 200px; height: 200px; background: #6bcaff; top: 50%; right: 15%; }
                ...
                .auth-btn { margin-top: 6px; padding: 14px; background: linear-gradient(135deg, #4CAF50 0%, #FF9800 100%); color: #fff; font-family: 'Nunito', sans-serif; font-size: 1rem; font-weight: 900; border: none; border-radius: 12px; cursor: pointer; transition: transform 0.15s; box-shadow: 0 6px 20px rgba(76,175,80,0.35); }
